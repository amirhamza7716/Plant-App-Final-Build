export const camra = require('../assets/icons/camera.png');
...
export const dowenArrow = require('../assets/icons/down-arrow.png');
...
export const plus = "helloplus";



const icons = {
    camra,back,chevron,cube ,dowenArrow ,drop,flash,focus,garden,heartGreenOutline,heart, heartRed,plus,search ,seed ,sun ,temperature, Plus 
}
